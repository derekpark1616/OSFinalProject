		...
		if (!(alg instanceof OptionallyPreemptiveSchedulingAlgorithm)) {
			...
			if (args.length > 3) {
				...
				if (args[2].toUpperCase().compareTo("PREEMPT") == 0
						...
						|| args[2].toUpperCase().compareTo("YES") == 0 || args[2].toUpperCase().compareTo("Y") == 0
						|| args[2].toUpperCase().compareTo("TRUE") == 0 || args[2].toUpperCase().compareTo("T") == 0
						|| args[2].toUpperCase().compareTo("1") == 0) {
					((OptionallyPreemptiveSchedulingAlgorithm) alg).setPreemptive(true);
				} else if (args[2].toUpperCase().compareTo("NON") == 0 || args[2].toUpperCase().compareTo("NO") == 0
						|| args[2].toUpperCase().compareTo("N") == 0 || args[2].toUpperCase().compareTo("FALSE") == 0
						|| args[2].toUpperCase().compareTo("F") == 0 || args[2].toUpperCase().compareTo("0") == 0) {
